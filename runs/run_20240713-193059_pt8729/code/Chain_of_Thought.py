...
Analyze_parser = MarkdownJsonDictParser(
    content_hint=    {
        "Main Task 1": {
            "Relationship level comparison": True or False,
            "Question subjective/objective type": True or False,
            "Topic relevance": True or False,
            "Search query": "...",
        },
        "Main Task 2": {
    ...
    required_keys=["Main Task 1", "Main Task 2"],
    keys_to_content=["Main Task 1", "Main Task 2"],
    keys_to_metadata=["Main Task 2"]
)
