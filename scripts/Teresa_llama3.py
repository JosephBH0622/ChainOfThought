...
from agentscope.agents import DialogAgent, DictDialogAgent, ReActAgent, DictDialogAgentLlama3
...
def Teresa():
    ...
    agentscope.init(
        ...
        model_configs="./configs/model_configs_our.json"
    )
    ...
    user = UserAgent()
    Analyzer = DictDialogAgentLlama3(
        name="Analyzer",
    ...
    Arbitrator = DictDialogAgentLlama3(
        name="Arbitrator",
    ...
    with msghub(
            ...
            announcement=Msg(name="Holder", content=Query, role="user"),
    ):
    ...
    response_strategy = Msg(name="assistant", content={**Query, **{"User Query Analysis": result.content},
                                                       ...
                                                       **{"How do you cope with User's emotion": Emotion.content[
                                                           "speak"]},
